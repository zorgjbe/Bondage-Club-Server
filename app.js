...
const IP_CONNECTION_LIMIT = process.env.IP_CONNECTION_LIMIT || 64; // Limit of connections per IP address
const IP_CONNECTION_RATE_LIMIT = process.env.IP_CONNECTION_RATE_LIMIT || 2; // Limit of newly established connections per IP address within a second
const CLIENT_MESSAGE_RATE_LIMIT = process.env.CLIENT_MESSAGE_RATE_LIMIT || 50; // Limit the number of messages received from a client within a second
